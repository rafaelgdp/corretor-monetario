...
def salvar_pdf(driver, mes, ano):
    ...
    rgb = Image.new('RGB', tamanho_maior, (255, 255, 255))  # white background
    rgb.paste(img, box=(left, top),  mask=img.split()[3])               # paste using alpha channel as mask
    ...
    existing_pdf = PdfFileReader(open(get_nome_arquivo_temp(mes, ano), "rb"))
